...
# Louis XVI: Guillotine – Can unconditionally attack one player at the current location. If victorious, all of that player’s Followers at this location are killed. This trait is invalid if the card moved during this turn.
...
# Schumann: Fantasia – Your cards in this location won't be affected by Survival Scenario in the first round this card deployed to, however cannot terminate the Survival Scenario.
